...
人称与语气：无主句或「主题 + 信息栏目」式短标题，像可保存的笔记条目名或搜索关键词；严禁出现：你觉得、你认为、你怎么看、你是否、对你来说、对你而言、请问你、你最喜欢 等面向读者的第二人称。条目标题不要用疑问句：避免以「吗」「呢」收尾，避免「如何理解 X？」「怎样看待 X？」这类向读者发问的句式——改成陈述式，如「X 的常见误解与澄清」「X 与 Y 的对比要点」。

具体性（极重要）：若笔记出现具体作品、人物、产品、软件名、事件，优先直呼其名；至少 3 条明显扣住笔记里的具体对象。少写空泛大类。

信息栏目（极重要）：优先短句，像「作品名 + 演员介绍」「作品名 + 幕后花絮」「作品名 + 同类型剧推荐」；或概念类「术语定义与沿革」「争议点与常见误区」「相关工具与资源」。工具/产品类：功能与定价、竞品对比、典型工作流、版本与口碑等可入库的信息维度。
...
每条约 8～36 字为宜，五条之间角度岔开。`;
    const user = `${ctxBlock}\n\n请写 5 条（中文），彼此角度不同。每条陈述「还能往知识库里补哪一类信息」，不要写成向用户提问；不要写分析读者情绪或付费心理的长 brief。

反例 A：通篇只写大类却不带笔记里的具体作品名、产品名或主题专名。
反例 B：封闭式考据 trivia。
反例 C：「你觉得…？」「如何理解…？」类发问句。
反例 D：大段论文式题目——改短成「主题 + 信息栏目」式。

正例·影视（风格参考，按笔记实际作品名替换）：放羊的星星演员介绍；放羊的星星幕后花絮；放羊的星星同类型剧推荐。
正例·软件（若笔记提到具体产品）：某软件主要功能与定价；某软件常见竞品对比；某类工具的典型使用场景。
