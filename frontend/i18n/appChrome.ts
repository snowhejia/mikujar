...
export type AppChrome = {
  ...
  /** 概览 Dashboard 文案 */
  overviewBrandTop: string;
  overviewBrandTopSub: string;
  overviewHeroWeekNew: (n: number) => string;
  /** Hero 前卡上问候语小字（昵称大字单独从 auth 读） */
  overviewHeroGreeting: string;
  /** Hero 右侧「随手一翻」随机笔记卡 */
  overviewRandomKicker: string;
  overviewRandomOpen: string;
  overviewRandomReroll: string;
  overviewRandomEmpty: string;
  /** 音乐播放器（右列顶部） */
  overviewMusicKicker: string;
  overviewMusicNoTracks: string;
  overviewMusicPrev: string;
  overviewMusicNext: string;
  overviewMusicPlay: string;
  overviewMusicPause: string;
  overviewMusicShuffle: string;
  /** 相册 */
  overviewPhotoKicker: string;
  overviewPhotoEmpty: string;
  overviewPhotoReroll: string;
  overviewPhotoPlay: string;
  overviewPhotoPause: string;
  overviewSectionTypes: string;
  overviewSectionNotifications: string;
  overviewSectionTodayCalendar: string;
  overviewSectionUpcoming: string;
  overviewSectionFavorites: string;
  overviewSectionRecent: string;
  overviewViewAll: string;
  overviewEmptyRecent: string;
  overviewEmptyFavorites: string;
  overviewEmptyNotifications: string;
  overviewEmptyWidgetCards: string;
};

const zh: AppChrome = {
  defaultCollectionHint:
    "欢迎光临 cardnote「卡片笔记」～ 一条笔记一件小事，按一天里的时刻慢慢堆满！左侧合集随便切；这段灰灰的字双击一下，就能换成你自己的开场白 ✨",
  ...
  adminUsersShort: "用户",
  loading: "正在整理卡片笔记…",
  loadingRemote: "正在整理你的卡片笔记…",
  syncing: "正在悄悄同步中…",
  searchNoHit: (q: string) =>
    `唔…「${q}」什么也没搜到，换个词或换个姿势试试？`,
  timelineBrand: "cardnote 时间线",
  ...
  overviewBrandTop: "CARDNOTE · 卡片笔记",
  overviewBrandTopSub: "你的类型中台 · 粉粉",
  overviewHeroWeekNew: (n) => `本周新增 +${n}`,
  overviewHeroGreeting: "HELLO ✧",
  overviewRandomKicker: "随手一翻 · RANDOM NOTE",
  overviewRandomOpen: "打开",
  overviewRandomReroll: "换一条",
  overviewRandomEmpty: "还没有笔记可以翻～先记一条试试？",
  overviewMusicKicker: "随机一曲 · NOW SPINNING",
  overviewMusicNoTracks: "还没有带封面的音频～",
  overviewMusicPrev: "上一轨",
  overviewMusicNext: "下一轨",
  overviewMusicPlay: "播放",
  overviewMusicPause: "暂停",
  overviewMusicShuffle: "随机换",
  overviewPhotoKicker: "相册 · PHOTO REEL",
  overviewPhotoEmpty: "还没有图片附件",
  overviewPhotoReroll: "换一张",
  overviewPhotoPlay: "恢复自动切换",
  overviewPhotoPause: "暂停自动切换",
  overviewSectionTypes: "类型汇总",
  overviewSectionNotifications: "通知",
  overviewSectionTodayCalendar: "今天的事",
  overviewSectionUpcoming: "待办 / 待跟进",
  overviewSectionFavorites: "收藏合集",
  overviewSectionRecent: "最近打开",
  overviewViewAll: "查看全部",
  overviewEmptyRecent: "还没有最近打开的合集",
  overviewEmptyFavorites: "标星合集后这里会展示",
  overviewEmptyNotifications: "暂无",
  overviewEmptyWidgetCards: "还没有内容",
};

const en: AppChrome = {
  defaultCollectionHint:
    "Welcome to cardnote — one note, one little thing, stacked through the day. Switch collections on the left; double‑click this gray line for your own intro ✨",
  ...
  timelineBrand: "cardnote timeline",
  ...
  overviewBrandTop: "CARDNOTE",
  overviewBrandTopSub: "Your type dashboard",
  overviewHeroWeekNew: (n) => `+${n} this week`,
  overviewHeroGreeting: "HELLO ✧",
  overviewRandomKicker: "RANDOM NOTE · shuffle a page",
  overviewRandomOpen: "Open",
  overviewRandomReroll: "Shuffle",
  overviewRandomEmpty: "No notes to shuffle yet — jot one down first?",
  overviewMusicKicker: "NOW SPINNING",
  overviewMusicNoTracks: "No audio with cover yet",
  overviewMusicPrev: "Previous",
  overviewMusicNext: "Next",
  overviewMusicPlay: "Play",
  overviewMusicPause: "Pause",
  overviewMusicShuffle: "Shuffle",
  overviewPhotoKicker: "PHOTO REEL",
  overviewPhotoEmpty: "No image attachments yet",
  overviewPhotoReroll: "Shuffle",
  overviewPhotoPlay: "Resume",
  overviewPhotoPause: "Pause",
  overviewSectionTypes: "By type",
  overviewSectionNotifications: "Notifications",
  overviewSectionTodayCalendar: "Today",
  overviewSectionUpcoming: "Due / upcoming",
  overviewSectionFavorites: "Favorites",
  overviewSectionRecent: "Recently opened",
  overviewViewAll: "View all",
  overviewEmptyRecent: "No recently opened collections yet",
  overviewEmptyFavorites: "Star a collection to see it here",
  overviewEmptyNotifications: "Nothing pending",
  overviewEmptyWidgetCards: "Nothing here yet",
};
