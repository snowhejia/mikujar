...
export type ExtraModalChrome = {
  ...
  /** 背景渐变开关 */
  noteSettingsBgGradientLabel: string;
  noteSettingsBgGradientAria: string;
  noteSettingsBgGradientOn: string;
  noteSettingsBgGradientOff: string;
...
const zh: ExtraModalChrome = {
  ...
  noteSettingsBgGradientLabel: "背景渐变",
  noteSettingsBgGradientAria: "是否启用 Sunrise Glow 页面背景渐变",
  noteSettingsBgGradientOn: "开启",
  noteSettingsBgGradientOff: "纯色",
...
const en: ExtraModalChrome = {
  ...
  noteSettingsBgGradientLabel: "Background gradient",
  noteSettingsBgGradientAria: "Toggle Sunrise Glow global gradient background",
  noteSettingsBgGradientOn: "On",
  noteSettingsBgGradientOff: "Plain",
